...
public class LoginDialog extends Dialog {
	...
	private void createContents() {
		...
		Button btnLogin = new Button(shlLoginToOpkey, SWT.NONE);
		btnLogin.setBounds(253, 236, 75, 25);
		btnLogin.setText("Login");
		
		Button btnClose = new Button(shlLoginToOpkey, SWT.NONE);
		...
		btnClose.setBounds(348, 236, 75, 25);
		...
		text.setBounds(192, 10, 178, 21);
		
		text_1 = new Text(composite_1, SWT.BORDER);
		text_1.setBounds(192, 55, 178, 21);
		
		text_2 = new Text(composite_1, SWT.BORDER);
		text_2.setBounds(192, 101, 178, 21);

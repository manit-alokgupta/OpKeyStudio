...
public class ArtifactCodeCompletionProvider {
	private static ArtifactCodeCompletionProvider instance;
	...
	public static ArtifactCodeCompletionProvider getInstance(ArtifactCodeView codedFunctionView) {
		if (instance == null) {
			instance = new ArtifactCodeCompletionProvider();
	...
	public static void initIntellisense(ArtifactCodeCompletionProvider provider, ArtifactCodeView cview) {

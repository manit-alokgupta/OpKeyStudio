...
public class AndroidSnapshotMobileElement extends RenderedTreeSnapshotMobileElement<Element> {
	...
	public void convertXMLElementToWebElementForAndroid(Element xmlElement) {
		...
		String objectName = xmlElement.getAttribute("text") != null ? xmlElement.getAttribute("text")
				: xmlElement.getAttribute("resource-id") != null ? xmlElement.getAttribute("resource-id")
						: xmlElement.getAttribute("content-desc") != null ? xmlElement.getAttribute("content-desc")

...
public class AndroidSnapshotMobileElement extends RenderedTreeSnapshotMobileElement<Element> {
	private static final long serialVersionUID = 337770111753669124L;
	...
	public void convertXMLElementToWebElementForAndroid(Element xmlElement) {
		...
		String objectName = (xmlElement.getAttribute("text") != null && xmlElement.getAttribute("text").length() > 0)
				? xmlElement.getAttribute("text")
				: (xmlElement.getAttribute("resource-id") != null
						&& xmlElement.getAttribute("resource-id").length() > 0)
								? xmlElement.getAttribute("resource-id")
								: (xmlElement.getAttribute("content-desc") != null
										&& xmlElement.getAttribute("content-desc").length() > 0)
												? xmlElement.getAttribute("content-desc")
												: xmlElement.getAttribute("class");

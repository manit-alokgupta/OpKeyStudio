...
public class UploadFile {
	 ...
	 * @param fileName        name of the file, just to show how to add the usual
	 *                        form parameters
	 * @param fileDescription some description for the file, just to show how to add
	 *                        the usual form parameters
	...
	public String executeMultiPartRequest(String urlString, File file, String fileName, String fileDescription) {
		...
		try {
			...
			/*
			 * Need to construct a FileBody with the file that needs to be attached and
			 * specify the mime type of the file. Add the fileBody to the request as an
			 * another part. This part will be considered as file part and the rest of them
			 * as usual form-data parts
			 */
